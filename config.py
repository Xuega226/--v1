...
QQ_PROACTIVE_DM_MIN_IDLE = int(os.getenv("QQ_PROACTIVE_DM_MIN_IDLE", "3600"))
QQ_PROACTIVE_DM_MAX_IDLE = int(os.getenv("QQ_PROACTIVE_DM_MAX_IDLE", "5400"))
...
QQ_PROACTIVE_OUTBOX_FILE = os.getenv(
    "QQ_PROACTIVE_OUTBOX_FILE", os.path.join(QQ_BOT_PERSIST_DIR, "proactive_outbox.json")
)
QQ_PROACTIVE_OUTBOX_CHECK_INTERVAL = max(
    5, int(os.getenv("QQ_PROACTIVE_OUTBOX_CHECK_INTERVAL", "30"))
)
QQ_PROACTIVE_OUTBOX_DAILY_MAX = max(
    1, min(10, int(os.getenv("QQ_PROACTIVE_OUTBOX_DAILY_MAX", "3")))
)
QQ_PROACTIVE_OUTBOX_MIN_GAP = max(
    60, int(os.getenv("QQ_PROACTIVE_OUTBOX_MIN_GAP", "7200"))
)
QQ_PROACTIVE_AUTONOMY_MIN_VALUE = max(
    0.0, min(1.0, float(os.getenv("QQ_PROACTIVE_AUTONOMY_MIN_VALUE", "0.65")))
)
